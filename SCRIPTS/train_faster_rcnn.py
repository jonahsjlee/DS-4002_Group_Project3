#!/usr/bin/env python3
"""
Fine-tune Faster R-CNN (ResNet-50 FPN) on preprocessed Aquarium VOC data and
...
Example:
  python3 SCRIPTS/train_faster_rcnn.py --data-root DATA/processed_aquarium --epochs 5
  python3 SCRIPTS/train_faster_rcnn.py --eval-only --resume OUTPUT/checkpoints_faster_rcnn/faster_rcnn_last.pt
"""
...
def _to_zero_indexed_labels(labels: torch.Tensor) -> torch.Tensor:
    """Faster R-CNN uses 1..K; torchmetrics detection expects 0..K-1."""
